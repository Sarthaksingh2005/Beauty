...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Desktop Navbar */}
      <header className="hidden md:flex fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-amber-200/60 via-yellow-100/50 to-amber-200/60 backdrop-blur-2xl border-b border-amber-300/60 shadow-md">
      ...
      {/* Mobile Top Bar */}
      <header className="md:hidden fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-amber-200/60 via-yellow-100/50 to-amber-200/60 backdrop-blur-2xl border-b border-amber-300/60 shadow-md">
